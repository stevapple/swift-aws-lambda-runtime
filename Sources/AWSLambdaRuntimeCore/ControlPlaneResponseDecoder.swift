...
extension AWSLambda {
    public struct ResponseDecoder: ControlPlaneResponseDecoder {
        ...
        public mutating func decode(buffer: inout ByteBuffer) throws -> Response? {
            switch self.state {
            case .waitingForNewResponse:
        ...
        public mutating func decodeLast(buffer: inout ByteBuffer, seenEOF: Bool) throws -> Response? {
        ...
        private mutating func decodeResponse(head: PartialHead, body: ByteBuffer?) throws -> Response {
...
extension AWSLambda.Invocation {
    fileprivate init(head: AWSLambda.ResponseDecoder.PartialHead) throws {
